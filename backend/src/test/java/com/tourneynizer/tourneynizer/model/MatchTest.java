...
public class MatchTest {
    ...
    public void json1() throws Exception {
        MatchChildren children = new MatchChildren(0L, 1L, null, null);
        Match match =
                new Match(0L, 0L, children, 3L, 0L, 0L, 0, 0, new Timestamp(0), new Timestamp(1), ScoreType.ONE_SET);
        String json = new ObjectMapper().writeValueAsString(match);
        String expected = "{\"id\":0,\"refId\":3,\"score1\":0,\"score2\":0,\"matchChildren\":[{\"id\":\"0\",\"type\":\"team\"},{\"id\":\"1\",\"type\":\"team\"}],\"courtNumber\":0,\"timeStart\":0,\"timeEnd\":1,\"scoreType\":\"ONE_SET\",\"tournamentId\":0,\"matchOrder\":0}";
