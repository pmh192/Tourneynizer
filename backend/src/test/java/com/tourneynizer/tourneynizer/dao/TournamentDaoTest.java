...
public class TournamentDaoTest extends TestWithContext {
    ...
    public void insert() throws Exception {
        ...
        Tournament tournament = new Tournament("name", 5.4, 3.4, null, 1, 1, TournamentType.VOLLEYBALL_BRACKET, user.getId());
    ...
    public void insertBadUserId() throws Exception {
        ...
        Tournament tournament = new Tournament("name", 5.4, 3.4, null, 1, 1, TournamentType.VOLLEYBALL_BRACKET, user.getId()-1);
        tournamentDao.insert(tournament, user);
    }
    ...
    public void insertEquality() throws Exception {
        ...
        Tournament tournament1 = new Tournament("name", 5.4, 3.4, null, 1, 1,
                TournamentType.VOLLEYBALL_BRACKET, user.getId());

        tournamentDao.insert(tournament1, user);
        Tournament tournament2 = new Tournament(tournament1.getId(),"name", 5.4, 3.4, tournament1.getTimeCreated(),null, 1, 1, TournamentType.VOLLEYBALL_BRACKET, user.getId());
    ...
    public void getAll() throws Exception {
        ...
        Tournament tournament1 = new Tournament("name1", 5.4, 3.4, null, 1, 1, TournamentType.VOLLEYBALL_BRACKET, user.getId());
        Tournament tournament2 = new Tournament("name2", 5.4, 3.4, null, 1, 1, TournamentType.VOLLEYBALL_BRACKET, user.getId());
        Tournament tournament3 = new Tournament("name3", 5.4, 3.4, null, 1, 1, TournamentType.VOLLEYBALL_BRACKET, user.getId());
        tournamentDao.insert(tournament1, user);
