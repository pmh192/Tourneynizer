...
public class TournamentDaoTest extends TestWithContext {
    ...
    public void insertBadUserId() throws Exception {
        ...
        Tournament tournament = new Tournament("name", "address", null, 1, 1, TournamentType.VOLLEYBALL_BRACKET, user.getId()-1);
        tournamentDao.insert(tournament, user);
    }
    ...
    public void insertEquality() throws Exception {
        ...
        Tournament tournament2 = new Tournament(tournament1.getId(),"name", "address", tournament1.getTimeCreated(),null, 1, 1, TournamentType.VOLLEYBALL_BRACKET, user.getId());
    ...
    public void getAll() throws Exception {
        ...
        Tournament tournament1 = new Tournament("name1", "address", null, 1, 1, TournamentType.VOLLEYBALL_BRACKET, user.getId());
        Tournament tournament2 = new Tournament("name2", "address", null, 1, 1, TournamentType.VOLLEYBALL_BRACKET, user.getId());
        Tournament tournament3 = new Tournament("name3", "address", null, 1, 1, TournamentType.VOLLEYBALL_BRACKET, user.getId());
        tournamentDao.insert(tournament1, user);
