...
import com.tourneynizer.tourneynizer.adapters.UIListAdapter;
...
public class HomeFragment extends Fragment {
    ...
    private final UIListAdapter[] ADAPTERS = new UIListAdapter[NUM_SEGMENTS];
    ...
    private SparseArray<UIListAdapter> listAdapters;
    ...
    public void refreshTournamentAdapter() {
        ...
        tournamentService.getAllTournaments(new TournamentService.OnTournamentsLoadedListener() {
            @Override
            public void onTournamentsLoaded(Tournament[] tournaments) {
